...
<!-- wp:post-excerpt {"moreText":"Read more","excerptLength":40,"style":{"spacing":{"margin":{"top":"10px","bottom":"0"},"padding":{"top":"0","bottom":"0"}},"typography":{"fontSize":"0.3rem"}}} /--></div>
<!-- /wp:group -->
<!-- /wp:post-template -->

<!-- wp:paragraph {"align":"right","placeholder":"Add text or blocks that will display when a query returns no results."} -->
<p class="has-text-align-right"><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>" data-type="page">View all →</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:query --></div>
<!-- /wp:group -->