...
function register_required_plugins() {
    $plugins = array(
        array(
            'name'      => 'Larris Form', // Plugin name
            'slug'      => 'larris-form', // The folder name of your plugin
            'source'    => 'https://github.com/ardiandev/larris-form/archive/refs/heads/main.zip', // GitHub repo zip URL
